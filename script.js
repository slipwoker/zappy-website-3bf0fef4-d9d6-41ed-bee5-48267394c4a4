    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בית חב״ד דרמסאלה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '3bf0fef4-d9d6-41ed-bee5-48267394c4a4',
                    name: data.name || '',
                    email: data.email || '',
